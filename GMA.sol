...
contract GMA is ERC20 {

    /// @notice Initializes the token with name and symbol
    /// @dev Token name is "Geo Mariani Alpha", symbol is "GMA"
    constructor() ERC20("Geo Mariani Alpha", "GMA") {}

    /// @notice Overrides the number of decimals for this token
    /// @dev Unlike the default 18, this token uses 2 decimals (e.g., 100 GMA = 100 * 10^2 = 10000 units)
    ...
    /// @param amount The amount to mint. For 1000 GMA, use: 1000 * 10**2 = 100000
